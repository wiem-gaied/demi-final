  ...
  return (
        <>
            ...
            <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-[#5524B7] to-[#380B60] text-white/70">
                <h2 className="text-2xl font-bold text-white">Plateforme GRC</h2>
                <p className="mt-4 text-center">Copyright © 2026 <a href="https://prebuiltui.com">plateforme GRC</a>. All rights reservered.</p>
